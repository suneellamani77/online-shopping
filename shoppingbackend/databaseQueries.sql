...
VALUES ('Virat', 'Kohli', 'ADMIN', true, '$2b$10$DOyOrWkb0wC6ExIB0OxmDuV.j8amsQZdGHsJ6YOTPi/pNkNOlTtIO', 'vk@gmail.com', '8888888888');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Ravindra', 'Jadeja', 'SUPPLIER', true, '$2b$10$fT7LS7wHVGnuYTMES/YW5.OVhQ.XFdkEkHEfdIXcXm9./UyjWItI2', 'rj@gmail.com', '9999999999');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Ravichandra', 'Ashwin', 'SUPPLIER', true, '$2b$10$fT7LS7wHVGnuYTMES/YW5.OVhQ.XFdkEkHEfdIXcXm9./UyjWItI2', 'ra@gmail.com', '7777777777');
